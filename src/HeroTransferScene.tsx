  ...
  return (
    <div className="hts-module" ref={moduleRef}>
      ...
      <div className="hts-counter hts-counter-left">
        ...
        <span className="hts-mana"><span className="hts-role">Giver</span>−{given}<span className="hts-unit-mana hts-unit-d">MANA</span></span>
      </div>

      <div className="hts-counter hts-counter-right">
        <span className="hts-clock hts-green">{fmt(given)}</span>
        <span className="hts-mana"><span className="hts-role">Receiver</span>+{given}<span className="hts-unit-mana hts-unit-r">MANA</span></span>
      </div>
    </div>
  );
}
